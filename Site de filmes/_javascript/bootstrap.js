...
/*SCRIPTS ADICIONADOS*/
        function mudaFoto() {
            document.getElementById("foto").src = "_imagens/edvard-grieg.jpg";
        }
        function voltaFoto(){
        document.getElementById("foto").src = "_imagens/edvard-grieg1.jpg";
        }
/*QUEM SOU EU SCRIPT*/
        function mudaFoto1() {
            document.getElementById("foto1").src = "_imagens/eumemos.jpg";
        }
        function voltaFoto2(){
        document.getElementById("foto1").src = "_imagens/eumemos1.jpg";
        }
/*MENU FIXO*/
